...
class PenginapanModel extends Model
{
  ...
  private function _get_datatables()
  {
    ...
    $this->select('penginapan.*, g.sumber');
    $this->join('galeri g', 'g.id_sumber=penginapan.id');
    $this->like('g.sumber', 'penginapan_');
  ...
  {
    return $this->join('galeri g', "penginapan.id=g.id_sumber")->groupBy("id_sumber")->like('sumber', "penginapan_");
  }

  public function joinGaleriGroupById()
  {
    return $this->select('*, penginapan.id idP')->join('galeri g', 'penginapan.id=g.id_sumber')->groupBy('idP');
  }
}
