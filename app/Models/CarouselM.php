...
class CarouselM extends Model{ 
    protected $table = 'carousel';
    protected $allowedFields = array('nama','gambar','status');
    ...
    protected $validationRules = ['nama' => 'required|max_length[150]',
		'gambar' => 'required|max_length[150]',
    ...
    protected $validationMessages = ['nama' => ['required' => 'tidak boleh kosong','max_length' => 'Maximal 150 Karakter'],
		'gambar' => ['required' => 'tidak boleh kosong','max_length' => 'Maximal 150 Karakter'],
		'status' => ['required' => 'tidak boleh kosong','max_length' => 'Maximal 1 Karakter'],
		];
    private function _get_datatables(){
        $column_search = array('nama','gambar','status');
        $i = 0;
...
/* End of file CarouselM.php */
/* Location: ./app/models/CarouselM.php */
