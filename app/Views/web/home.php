    ...
    <div class="col-lg-8 mb-10">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              <h3 class="mb-15 title">Sambutan Camat Sangkup Kabupaten Bolaang Mongondow Utara.</h3>
              <p class="text-justify mb-5">
                Website ini dimaksudkan sebagai sarana publikasi untuk memberikan Informasi dan gambaran tentang potensi Kecamatan Sangkup Kabupaten Bolaang Mongondow Utara serta meningkatkan pelayanan kepada masyarakat untuk mengakses informasi. Melalui keberadaan website ini kiranya masyarakat dapat mengetahui seluruh informasi tentang kebijakan Pemerintah Kabupaten Bolaang Mongondow Utara, khususnya Kecamatan Sangkup.
              </p>
              <div class="d-flex mt-2">
                <div class="flex-shrink-0">
                  <img src="https://source.unsplash.com/300x300?person" alt="Camat Sangkup" class="mr-3 rounded-circle" style="width:60px;">
                </div>
                <div class="flex-grow-1 ms-3">
                  <h5 class="mb-0">Kamdin Thalib, Gelar</h5>
                  <p class="text-muted">Camat Sangkup</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-center mb-5">
        <h2 class="heading-section">#KecamatanSangkup</h2>
