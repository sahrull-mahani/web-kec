...
<div class="container mt-5 pb-5">
  <div class="row">
    <div class="col-lg-8">
      <div class="row">
        <div class="col-md-12">
          <h6 class="text-custom-5 text-uppercase"><i class="fa fa-clock-o"></i> <?= hariIni('D', strtotime($kuliner->published_at)) . ", " . date('d-m-Y H.i', strtotime($kuliner->published_at)) ?> WITA</h6>
          <h1 class="text-capitalize"><?= ucwords($kuliner->nama) ?></h1>
          ...
          <div class="grid-wrapper mb-5">
            <?php foreach ($gambar as $gmb) : ?>
              <a href="<?= base_url("Web/img_medium/$gmb->sumber") ?>" class="mason" data-lightbox="masonry" data-title="image-<?= $kuliner->nama ?>">
        ...
        <?php foreach ($kulinerLain as $pari) : ?>
          <div class="col-md-6">
            <div class="card">
