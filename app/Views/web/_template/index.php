...
<body>
  <div class="page-wraper">
    ...
    <nav class="bd-subnavbar navbar navbar-expand-md navbar-dark fixed-top bg-custom-1">
      <div class="container">
        <a class="navbar-brand" href="/">Kecamatan Bolangitang Timur</a>
          ...
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                ...
                <li><a class="dropdown-item" href="/web/prestasi">Prestasi Bolangitang Timur</a></li>
            ...
            <li class="nav-item">
              <a class="nav-link <?= $active == 'tentang' ? "active" : '' ?>" aria-current="page" href="/web/tentang">Sekilas Bolangitang Timur</a>
            </li>
          </ul>
      ...
      <div class="row">
        <div class="col-md">
          ...
          <ul class="list-group list-group-flush footer">
            ...
            <li class="list-group-item"><a href="/home/prestasi">Prestasi Bolangitang Timur</a></li>
          ...
          <ul class="list-group list-group-flush footer">
            <li class="list-group-item d-flex justify-content-between align-items-start">
              <div class="ms-2 me-auto">
                ...
                Kec. Bolangitang Timur Kab. Bolaang Mongondow Utara
              </div>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-start">
              <div class="ms-2 me-auto">
                <div class="fw-bold"><i class="fa fa-envelope"></i> Email</div>
                camatBolangitang Timur@gmail.com
              </div>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-start">
              <div class="ms-2 me-auto">
                <div class="fw-bold"><i class="fa fa-globe"></i> Website</div>
                camatBolangitang Timur.bolmutkab.go.id
              </div>
            </li>
          </ul>
  ...
  <div class="footer-bottom py-3">
    <p class="m-0">Copyright &copy; <?= date("Y") ?> | Kecamatan Bolangitang Timur Kabupaten Bolaang Mongondow Utaran</p class="m-0">
  </div>
