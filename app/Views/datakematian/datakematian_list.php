                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="toolbar">
                                <?php if (is_admin()) : ?>
                                <form action="<?= site_url("DataKematian/export"); ?>" method="post"
                                    class="form-inline">
                                ...
                                <a href="post-datakematian"><button type="button" class="btn btn-primary"><i
                                            class="fa fa-plus"></i> Tambah</button></a>
                                <button type="button" class="btn btn-warning" id="single-edit" data-href="datakematian"
