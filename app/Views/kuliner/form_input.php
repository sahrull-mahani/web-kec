<?= form_open_multipart('kuliner/save', array('class' => 'form-horizontal mode2')); ?>
<div class="card-body">
    ...
    <input id="input-edit-kuliner" type="file" name="userfile[]" accept=".jpg, .png, image/jpeg, image/png" multiple>
</div>
    ...
    $('#publish').click(function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: location.origin + "/kuliner/save",
                    type: 'POST',
                    data: {
                        id: '<?= $get->id ?>',
                        action: 'publish',
