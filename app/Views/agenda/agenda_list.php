                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="toolbar">
                                ...
                                <?php if (is_admin()) : ?>
                                    <button type="button" class="btn btn-info" id="detail" method="detail" disabled><i class="fa fa-retweet"></i> Detail</button>
                                <?php endif ?>
                            ...
                            <table id="table" data-toggle="table" data-ajax="ajaxRequest" data-side-pagination="server" data-pagination="true" data-search="true" data-show-columns="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-click-to-select="true" data-toolbar="#toolbar">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="isi_agenda">Isi Agenda</th>
                                        <th data-field="lokasi">Lokasi</th>
                                        <?php if (is_admin()) : ?>
                                            <th data-field="id_user">Nama User</th>
                                        <?php endif ?>
                                        <th data-field="published_at">Status</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
