            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="toolbar">
                                <input type="number" class="btn  btn-default d-none" value="1" id="number-of-row">
                                <button type="button" class="btn btn-primary create d-none" method="create" data-toggle="modal"><i class="fa fa-plus"></i> Tambah Data</button>
                                <button type="button" class="btn btn-warning" id="edit" method="edit" disabled><i class="fa fa-edit"></i> Edit</button>
                                <button type="button" class="btn btn-danger d-none" id="remove" disabled><i class="fa fa-trash"></i> Hapus</button>
                            </div>
