...
<section class="content">
  <div class="box box-warning">
    <div class="box-header with-border">
      <h3 class="box-title">Input Pariwisata</h3>
    ...
    <!-- /.box-header -->
    <div class="box-body">
      <form action="/pariwisata/process_input_pariwisata" method="post" enctype="multipart/form-data">
        <?= csrf_field() ?>

        <div class="form-group <?= ($validation->hasError('nama')) ? 'has-error' : '' ?>">
          <label>Nama</label>
          <input type="text" class="form-control" placeholder="Enter ..." name="nama" value="<?= old('nama') ?>">
