    ...
    <div class="col-md-12">
      <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title"><?= $program->judul ?> | </h3> <i class="fa fa-clock-o"></i> <?= hariIni('D', strtotime($program->created_at)) . ", " . date('d-m-Y H.i', strtotime($program->created_at)) ?>
        ...
        <div class="box-body">
          ...
          <?php if ($program->published_at == null) : ?>
            <hr>
            <a href="/program/publish_program/<?= $program->idPro ?>" class="btn btn-primary btn-ask" data-judul="Publish" data-text="Publish <?= $program->judul ?>">PUBLISH</a>
          <?php endif ?>
        </div>
        <!-- /.box-body -->
      </div>
