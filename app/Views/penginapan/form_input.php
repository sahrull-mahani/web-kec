<?= form_open_multipart('penginapan/save', array('class' => 'form-horizontal mode2')); ?>
<div class="card-body">
    ...
    <textarea name="keterangan" id="keterangan" class="form-control my-4" cols="30" rows="10" placeholder="Keterangan...."><?= (isset($get->keterangan)) ? $get->keterangan : ''; ?></textarea>
    <input id="input-edit-penginapan" type="file" name="userfile[]" accept=".jpg, .png, image/jpeg, image/png" multiple>
</div>
...
<script type='text/javascript'>
    ...
    // })
    $("#input-edit-penginapan").fileinput({
        'showUpload': false,
        'showRemove': false,
        'showCancel': false,
    ...
    $('#publish').click(function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: location.origin + "/penginapan/save",
                    type: 'POST',
                    data: {
                        id: '<?= $get->id ?>',
                        action: 'publish',
