  ...
  <div class="row">
    <div class="col-lg-8">
      <div class="col-md-12 mb-5">
        <h2>Potensi Bidang Pendidikan</h2>
      </div>
                ...
                <?php else : ?>
                  ...
                  <?php foreach ($pendidikan as $pnd) : ?>
                    <tr>
                      ...
                      <td class="align-middle"><?= ucwords($pnd->judul) ?></td>
                      <td class="align-middle"><?= substr(ucfirst(strip_tags($pnd->isi_potensi)), 0, 60) . "..." ?></td>
                      <td>
                      ...
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel"><?= ucwords($pnd->judul) ?></h5>
