                ...
                <?php else : ?>
                  ...
                  <?php foreach ($industri as $ind) : ?>
                    <tr>
                      ...
                      <td class="align-middle"><?= ucwords($ind->judul) ?></td>
                      <td class="align-middle"><?= substr(ucfirst(strip_tags($ind->isi_potensi)), 0, 60) . "..." ?></td>
                      <td>
                      ...
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel"><?= ucwords($ind->judul) ?></h5>
