                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="toolbar">
                                <?php if(!is_admin()): ?>
                                    <a href="post-datapindah"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</button></a>
                                    <button type="button" class="btn btn-warning" id="single-edit" data-href="datapindah" method="edit" disabled><i class="fa fa-edit"></i> Update</button>
